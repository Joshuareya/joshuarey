...
export const notes: FieldNote[] = [
  {
    ...
    excerpt:
      "One digit in a ten-character string, and ₦250,000 moved to a stranger. The riskiest moments are the ones that feel routine.",
    read: "3 min",
    ...
    body: [
      ...
      "One digit. Somewhere in ten characters, I'd typed the wrong one — and ₦250,000 moved to a stranger, a different bank, a different name. Days of calls and disputes later, most of it was simply gone.",
      ...
      "Once I saw it as a behavior problem rather than a 'mistake,' the system became obvious. People don't mistype because they're careless. They mistype because typing ten digits correctly, under no particular pressure, is simply harder than it looks — and there's no feedback loop until the money is already gone.",
